...
export default function InfoPage() {
    ...
    useEffect(() => {
        document.body.classList.add("info-page-bg");

        return () => {
            document.body.classList.remove("info-page-bg");
        };
    }, []);
            ...
            <div style={{ position: "relative", height: "100vh", width: "100%" }}>
                ...
                />
                    ...
                    <RotatedCheck
                        ...
                        responsivePosition={(width) => {
                            if (width < 1600) {
                                return { top: "calc(100% + 140px)", left: "10%" };
                            }
                        ...
                        content={
                            <>
                                ...
                                <div className="list-block-hack">
                                    <p><b>2 место</b> в составе команды «АтомDev#» в хакатоне <br/>«АТОМХАК» при ВИШ НИЯУ МИФИ и АСЭ Росатом.<br/>20-21 марта 2024 г.<br/>Роль в команде: дизайнер.</p>
                                    <p><b>Номинация “Лучшая защита проекта”</b> в составе команды «АтомDev#» в хакатоне VK Mini Apps х ITMO Hack.<br/>11-13 октября 2024 г.<br/>Роль в команде: дизайнер, фронтент.</p>
                                    <p><b>1 место</b> в составе команды «АтомDev#» в хакатоне BIV Hack Challenge.<br/>15-17 ноября 2024 г.<br/>Роль в команде: дизайнер, фронтент.</p>
                                    <p><b>2 место</b> в составе команды «АтомDev#» в хакатоне BEST HACK’25 при МГТУ Баумана.<br/>1-2 марта 2025 г.<br/>Роль в команде: дизайнер, фронтент.</p>
                                    <p><b>Финалисты</b> в составе команды «АтомDev#» в хакатоне ВНЕДРЕЙД 2025 от Orion.<br/>7-8 июня 2025 г.<br/>Роль в команде: дизайнер, фронтент.</p>
                                </div>
                            </>
                        }
                    />
